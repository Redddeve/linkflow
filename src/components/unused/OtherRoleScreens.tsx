...
import { PageHeader, Stat, SiteStatusBadge, UserAvatar } from './chrome';
  ...
  return (
    <div className="page">
      ...
      <PageHeader
        ...
        sub={
          <>
            <span className="mono">T-201</span> · ORD-1042 · Due May 06
          </>
        }
        actions={
          <>
        ...
        <div>
          <Card className="p-3.5 mb-4">
            <div className="hstack" style={{ marginBottom: 10 }}>
              <span className="badge b-assign">
                <span className="dot" />
                Brief
              </span>
              <span className="muted text-sm">
                800 words · informational tone
              </span>
            </div>
            <div className="text-sm">
              Write a 800-word informational article about{' '}
              <strong>&ldquo;best widgets&rdquo;</strong>, linking to{' '}
              <span className="mono">/landing-page-1</span> using the anchor
              &ldquo;best widgets&rdquo;. Avoid direct comparison; focus on
          ...
          <div className="editor-doc">
            ...
            <p>
              Widgets have come a long way since the early days. What was once a
              single-axis decision — price vs. capability — is now a
              multidimensional choice that touches your team&rsquo;s workflow,
              your downstream tooling, and your long-term roadmap.
            </p>
            <h2>Three things to evaluate first</h2>
            <p>
              Before you start comparing brands, take a step back and ask three
              questions about your own context. The team&rsquo;s existing skills
              are the single biggest predictor of whether a widget will actually
              get adopted, regardless of its features on paper.
            </p>
            <p>
              For most teams, the right starting point is a short list of{' '}
              <span className="anchor">best widgets</span> that fit the way the
              team already works — then narrow from there based on price and
              integration support.
            </p>
        ...
        <Card>
          <div className="side-section">
            ...
            <div className="side-row">
              ...
              <span className="v mono">/landing-page-1</span>
            </div>
            <div className="side-row">
              <span className="k">Anchor</span>
              <span className="v">&ldquo;best widgets&rdquo;</span>
            </div>
            <div className="side-row">
              <span className="k">Word count</span>
              <span className="v mono">800</span>
            </div>
            <div className="side-row">
              <span className="k">Tone</span>
              <span className="v">Informational</span>
            </div>
          </div>
          <div className="side-section">
            ...
            <div className="side-row">
              ...
              <span className="v mono">site-alpha.com</span>
            </div>
            <div className="side-row">
              <span className="k">Category</span>
              <span className="v">Tech</span>
            </div>
          </div>
          <div className="side-section">
            ...
            >
              ...
              <div className="body">
                <div className="head">
                  <span className="who">Manager A</span>
                  <span className="when">1d ago</span>
                </div>
                <div className="text text-sm">
                  Try to keep H2s under 60 chars for this domain.
                </div>
              </div>
            </div>
          </div>
...
export function SourcerSubmit({ back }: { back: () => void }) {
  ...
  return (
    <div className="page">
      ...
      <PageHeader
        title="Submit a new site"
        sub="If approved, you earn commission on every order placed on this site."
      />
      <div className="split">
        <Card className="p-5">
          <div className="field">
          ...
          >
            <div className="field">
              <Label>DR</Label>
              <Input className="mt-1.5" placeholder="0–100" />
            </div>
            <div className="field">
              <Label>Monthly traffic</Label>
              <Input className="mt-1.5" placeholder="e.g. 25K" />
            </div>
            <div className="field">
              <Label>Price (USD)</Label>
              <Input className="mt-1.5" placeholder="e.g. 250" />
            </div>
          </div>
          <div className="field" style={{ marginBottom: 0 }}>
            ...
            <Textarea
              className="mt-1.5"
              placeholder="Editorial guidelines, contact, anything reviewers should know…"
            />
          </div>
        </Card>
        <Card>
          ...
          <div className="side-section">
            ...
            <div className="side-row">
              ...
              <span className="v">Sourcer A · Tier 2</span>
            </div>
            <div className="side-row">
              <span className="k">Rate</span>
              <span className="v mono">15%</span>
            </div>
          </div>
...
export function SourcerEarnings() {
  return (
    <div className="page">
      <PageHeader
        title="Commissions"
        sub="Earnings from approved sites."
        actions={
      ...
      <Card className="mb-4">
        <CardHeader className="card-h">
          <CardTitle className="card-h-title">
  ...
  return (
    <div className="page">
      <PageHeader
        ...
        sub="Review submitted sites and approve or reject."
      />
            ...
            >
              <div>
                ...
                <div className="text-xs muted">
                  Submitted by {s.sourcer} · {s.category}
                </div>
              </div>
              <div
                style={{
              ...
              >
                <div>
                  <div className="text-xs muted">DR</div>
                  <div className="mono" style={{ fontWeight: 500 }}>
                    {s.dr}
                  </div>
                </div>
                <div>
                  <div className="text-xs muted">Traffic</div>
                  <div className="mono" style={{ fontWeight: 500 }}>
                    {s.traffic}
                  </div>
                </div>
              ...
              <div className="hstack">
                <Button variant="outline" className="text-(--st-rejected-fg)">
                  Reject
                </Button>
                <Button>
