...
import { markOrdersPayoutPaid } from '@/app/dashboard/earnings/actions';
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Record an external payout reference (transfer ID, invoice number,
              etc.) and mark {selected.size} order
