...
import type { MessageRow, ChatCategory, ChatParticipant } from '@/lib/data/chat';
  ...
  return (
    <div className="space-y-4">
      {messages.map((msg) => {
        ...
        const maskAuthor = maskCategory && !isOwn && isInternalRole(msgAuthor?.role);
        ...
        const authorName = maskAuthor
          ...
          : msgAuthor
            ...
            : 'Unknown';
        const avatarInitials = maskAuthor ? 'S' : msgAuthor ? initials(msgAuthor) : '?';
