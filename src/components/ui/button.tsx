...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground border-primary-active/20 shadow-[0_1px_0_rgb(255_255_255/0.18)_inset,0_1px_2px_color-mix(in_srgb,var(--primary)_45%,transparent)] hover:bg-primary-hover hover:shadow-[0_1px_0_rgb(255_255_255/0.18)_inset,0_2px_8px_color-mix(in_srgb,var(--primary)_45%,transparent)] active:bg-primary-active [a]:hover:bg-primary-hover',
        outline:
          'border-border bg-card text-foreground shadow-xs hover:bg-muted hover:border-(--border-strong) aria-expanded:bg-muted aria-expanded:text-foreground',
        secondary:
      ...
      size: {
        ...
        tag: "h-6 gap-1 rounded-full px-2.5 text-xs font-medium has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
