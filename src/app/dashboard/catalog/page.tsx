...
export default async function CatalogPage({ searchParams }: PageProps) {
  ...
  const filters: CatalogFilters = {
    ...
    linkType:
      typeof params.link_type === 'string'
        ? (params.link_type as LinkType)
        : undefined,
    drMin:
      typeof params.dr_min === 'string' ? Number(params.dr_min) : undefined,
    drMax:
      typeof params.dr_max === 'string' ? Number(params.dr_max) : undefined,
    priceMin:
